...
import { adminCheckEmailExisted, adminResetPassword } from "../api/adminUser";
			...
			<Card style={{ width: 500 }} title="重置密码">
				...
				>
						...
						rules={[
							{
								validator: async (_, value) => {
									...
									const existed = await adminCheckEmailExisted(value);
					...
					>
						<EmailVerification
							form={form}
							verifiedFieldName="emailVerified"
							api={adminCheckEmailExisted}
						/>
					</Form.Item>
